...
func (TypefulBinding) ToObject(bytes []byte) interface{} {
	...
	return &Typeful{
		...
		Int:        table.OffsetAsInt(6),
		Int8:       table.OffsetAsInt8(8),
		Int16:      table.OffsetAsInt16(10),
		Int32:      table.OffsetAsInt32(12),
		Int64:      table.OffsetAsInt64(14),
		Uint:       table.OffsetAsUint(16),
		Uint8:      table.OffsetAsUint8(18),
		Uint16:     table.OffsetAsUint16(20),
		Uint32:     table.OffsetAsUint32(22),
		Uint64:     table.OffsetAsUint64(24),
		Bool:       table.OffsetAsBool(26),
		String:     table.OffsetAsString(28),
		Byte:       table.OffsetAsByte(30),
		ByteVector: table.OffsetAsByteVector(32),
		Rune:       table.OffsetAsRune(34),
		Float32:    table.OffsetAsFloat32(36),
		Float64:    table.OffsetAsFloat64(38),
		Date:       table.OffsetAsUint64(40),
	}
}
