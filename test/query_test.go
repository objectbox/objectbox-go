...
func TestQueries(t *testing.T) {
	...
	testCases := []struct {
		...
		{2, `String ==(i) "Val-1"`, box.Query(E.String.Equals(e.String, false))},
		{999, `String != "Val-1"`, box.Query(E.String.NotEquals(e.String, true))},
		{998, `String !=(i) "Val-1"`, box.Query(E.String.NotEquals(e.String, false))},
		{64, `String contains "Val-1"`, box.Query(E.String.Contains(e.String, true))},
		{131, `String contains(i) "Val-1"`, box.Query(E.String.Contains(e.String, false))},
		{64, `String starts with "Val-1"`, box.Query(E.String.HasPrefix(e.String, true))},
		{131, `String starts with(i) "Val-1"`, box.Query(E.String.HasPrefix(e.String, false))},
		{1, `String ends with "Val-1"`, box.Query(E.String.HasSuffix(e.String, true))},
		{2, `String ends with(i) "Val-1"`, box.Query(E.String.HasSuffix(e.String, false))},
		{998, `String > "Val-1"`, box.Query(E.String.GreaterThan(e.String, true))},
		{498, `String >(i) "Val-1"`, box.Query(E.String.GreaterThan(e.String, false))},
		{999, `String >= "Val-1"`, box.Query(E.String.GreaterOrEqual(e.String, true))},
		{500, `String >=(i) "Val-1"`, box.Query(E.String.GreaterOrEqual(e.String, false))},
		{1, `String < "Val-1"`, box.Query(E.String.LessThan(e.String, true))},
		{500, `String <(i) "Val-1"`, box.Query(E.String.LessThan(e.String, false))},
		{2, `String <= "Val-1"`, box.Query(E.String.LessOrEqual(e.String, true))},
		{502, `String <=(i) "Val-1"`, box.Query(E.String.LessOrEqual(e.String, false))},
		{2, `String in ["VAL-1", "val-860714888"]`, box.Query(E.String.In(true, "VAL-1", "val-860714888"))},
		{3, `String in(i) ["val-1", "val-860714888"]`, box.Query(E.String.In(false, "VAL-1", "val-860714888"))},
		...
		{998, `Int64 not in [94|47]`, box.Query(E.Int64.NotIn(e.Int64, e.Int64*2))},
		...
		{998, `Uint64 not in [94|47]`, box.Query(E.Uint64.NotIn(e.Uint64, e.Uint64*2))},
		...
		{998, `Int not in [94|47]`, box.Query(E.Int.NotIn(e.Int, e.Int*2))},
		...
		{998, `Uint not in [94|47]`, box.Query(E.Uint.NotIn(e.Uint, e.Uint*2))},
		...
		{997, `Rune not in [94|47]`, box.Query(E.Rune.NotIn(e.Rune, e.Rune*2))},
		...
		{997, `Int32 not in [94|47]`, box.Query(E.Int32.NotIn(e.Int32, e.Int32*2))},
		...
		{997, `Uint32 not in [94|47]`, box.Query(E.Uint32.NotIn(e.Uint32, e.Uint32*2))},
		...
		{6, `ByteVector == byte[5]{0x01020305 08}`, box.Query(E.ByteVector.Equals(e.ByteVector))},
		//{994,`ByteVector != `, box.Query(E.ByteVector.NotEquals(e.ByteVector))},
		{989, `ByteVector > byte[5]{0x01020305 08}`, box.Query(E.ByteVector.GreaterThan(e.ByteVector))},
		{995, `ByteVector >= byte[5]{0x01020305 08}`, box.Query(E.ByteVector.GreaterOrEqual(e.ByteVector))},
		{5, `ByteVector < byte[5]{0x01020305 08}`, box.Query(E.ByteVector.LessThan(e.ByteVector))},
		{11, `ByteVector <= byte[5]{0x01020305 08}`, box.Query(E.ByteVector.LessOrEqual(e.ByteVector))},
