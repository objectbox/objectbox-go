...
func TestQueryDescribe(t *testing.T) {
	...
	testCases := []struct {
		...
		//{5, `Int8 between -1 and 1`, box.Query(E.Int8.Between(-1, 1))},
		...
		//{5, `Uint8 between 0 and 1`, box.Query(E.Uint8.Between(0, 1))},
		...
		//{5, `Byte == 47`, box.Query(E.Byte.Equal(0))},
		...
		//{5, `Byte between 0 and 1`, box.Query(E.Byte.Between(0, 1))},
		...
		//{2, `Float64 between -1.000000 and 1.000000`, box.Query(E.Float64.Between(-1, 1))},
		...
		//{500, `Float32 < 47.2740002`, box.Query(E.Float32.LessThan(e.Float32))},
		//{2, `Float32 between -1.000000 and 1.000000`, box.Query(E.Float32.Between(-1, 1))},
