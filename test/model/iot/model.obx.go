...
func (event_EntityInfo) PutRelated(txn *objectbox.Transaction, object interface{}) error {
	return nil
}
...
// PutRelated is called by the ObjectBox to put related entities before the object itself is flattened and put
func (reading_EntityInfo) PutRelated(txn *objectbox.Transaction, object interface{}) error {
	return nil
}
