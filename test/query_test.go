...
func TestQueries(t *testing.T) {
	...
	testCases := []struct {
		...
		{64, `String contains "Val-1"`, box.Query(E.String.Contain(e.String, true))},
		{131, `String contains "Val-1"`, box.Query(E.String.Contain(e.String, false))},
		{64, `String starts with "Val-1"`, box.Query(E.String.StartWith(e.String, true))},
		{131, `String starts with "Val-1"`, box.Query(E.String.StartWith(e.String, false))},
		{1, `String ends with "Val-1"`, box.Query(E.String.EndWith(e.String, true))},
		{2, `String ends with "Val-1"`, box.Query(E.String.EndWith(e.String, false))},
